...
class _glp_vertex(_object):
    ...
    __swig_setmethods__["in"] = _glpki._glp_vertex_in_set
    __swig_getmethods__["in"] = _glpki._glp_vertex_in_get
    if _newclass:in = _swig_property(_glpki._glp_vertex_in_get, _glpki._glp_vertex_in_set)
